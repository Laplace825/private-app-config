# Generated by Powerlevel10k configuration wizard on 2024-08-14 at 00:25 CST.
...
# slanted separators, blurred heads, sharp tails, 2 lines, dotted, left frame,
...
() {
  ...
  # typeset -g POWERLEVEL9K_CPU_ARCH_X86_64_VISUAL_IDENTIFIER_EXPANSION="SS"
  ...
  # typeset -g POWERLEVEL9K_USERNAME_FOREGROUND=232
  # typeset -g POWERLEVEL9K_USERNAME_BACKGROUND=7
